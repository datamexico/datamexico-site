...
const icons = ["Affected Legal Good", "State", "Area", "Category", "Chapter", "Continent", "Country", "Flow", "Generic Investment", "Sector", "Sex", "Crime Type", "Work Mean", "Authorities Trust", "Work Type", "Basic Services", "Student Type"];
