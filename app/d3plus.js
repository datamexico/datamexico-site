...
const icons = ["Affected Legal Good", "State", "Area", "Category", "Chapter", "Continent", "Country", "Flow", "Generic Investment", "Sector", "Sex", "Crime Type", "Work Mean", "Confidence in Federal Police", "Classification of Formal and Informal Jobs of the First Activity", "Status", "Basic Services"];
